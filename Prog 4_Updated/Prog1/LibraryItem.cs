...
// Includes IComparable interface to compare and sort items
...
namespace LibraryItems
{
    public abstract class LibraryItem : IComparable<LibraryItem>
    {
        ...
        public int CompareTo(LibraryItem item2)
        {
            ...
            if (this.Title.CompareTo(item2.Title) != 0) // is item2 Title not null?
                return this.Title.CompareTo(item2.Title); // return Title comparison
            else if (this.Publisher.CompareTo(item2.Publisher) != 0) // is item2 Pub not null?
                return this.Publisher.CompareTo(item2.Publisher); // return pub comparison
            else if (this.CopyrightYear.CompareTo(item2.CopyrightYear) != 0) // is item2 copyright year not null?
                return this.CopyrightYear.CompareTo(item2.CopyrightYear); // return copyrighy year comparison
            else if (this.LoanPeriod.CompareTo(item2.LoanPeriod) != 0) // is item2 loan period not null?
                return this.LoanPeriod.CompareTo(item2.LoanPeriod); // return lp comparison
            else // is item2 cn period not null?
                return this.CallNumber.CompareTo(item2.CallNumber); // return cn comparison
